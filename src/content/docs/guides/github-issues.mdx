...
:::note
To create the issues, templates are used to generate the initial content. Find more details [here](https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/configuring-issue-templates-for-your-repository#creating-issue-templates).
:::
...
### Our GitHub Issues Templates
Issues are of two categories: for regular projects and for open source projects (since open source requires specific kind of management).

For regular project tasks, we have a template for each task type (e.g frontend, backend, mobile). Here are the templates we currently use:
...
:::note
Templates may be updated by time as new refinements are thought of.
:::

## Further Reading

- Learn more about [GitHub Issues](https://docs.github.com/en/issues) and how to use them effectively.
- Explore [GitHub Projects](https://docs.github.com/en/enterprise-server@3.15/issues/planning-and-tracking-with-projects/learning-about-projects/about-projects) for advanced task tracking and planning.
