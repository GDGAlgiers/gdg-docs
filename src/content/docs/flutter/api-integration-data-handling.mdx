...
class ApiClient {
  ...
  // Implement other methods: put, delete, patch...
  
  // Error handling
  Exception _handleError(dynamic error) {
    // We'll implement this in the Error Handling section
...
class ProductRepository {
  ...
  Future<Product> getProductDetails(String productId, {CancelToken? cancelToken}) async {
    final endpoint = ApiEndpoints.replacePathParameters(
      ApiEndpoints.getProductDetails,
      {'id': productId},
    );
...
class ErrorInterceptor extends Interceptor {
  ...
  void onError(
    ...
    // Convert DioExceptions to more user-friendly errors
